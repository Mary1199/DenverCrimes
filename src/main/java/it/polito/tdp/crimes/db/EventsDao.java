...
public class EventsDao {
	...
	public List<String> listaCategorieReati(String categoria, int mese){
		String sql = "SELECT DISTINCT offense_category_id FROM EVENTS WHERE offense_category_id=? AND Month(reported_date)=?";
		try {
			Connection conn = DBConnect.getConnection() ;
